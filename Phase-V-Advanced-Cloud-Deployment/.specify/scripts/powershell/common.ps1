...
function Get-RepoRoot {
    # Check if the current working directory is itself a Git repository root.
    # This handles cases where the agent is invoked from a sub-project that is also a Git repo.
...
function Get-FeaturePathsEnv {
    ...
    [PSCustomObject]@{
        REPO_ROOT     = $repoRoot
        PROJECT_ROOT  = $projectRoot # New variable
