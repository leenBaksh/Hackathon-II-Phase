        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Discord</h2>
                <p className="text-gray-600 dark:text-gray-300">Join our Discord server</p>
              </div>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
              Connect with other users, share tips, and get help in real-time.
            </p>
          </motion.a>
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Explore our repositories</p>
              </div>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Follow us on LinkedIn</p>
              </div>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
              Stay updated with company news and professional announcements.
            </p>
          </motion.a>
        </div>
      </div>
