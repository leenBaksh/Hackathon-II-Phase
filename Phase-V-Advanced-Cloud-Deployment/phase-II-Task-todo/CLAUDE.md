...
For this project, we will follow the Agentic Dev Stack workflow: Write spec → Generate plan → Break into tasks → Implement via Claude Code. No manual coding allowed.
...
- **Frontend Agent**: Develop the frontend interface using Next.js
- **DB Agent**: Manage database design and operations with Neon Serverless PostgreSQL
- **Backend Agent**: Develop FastAPI backend services
