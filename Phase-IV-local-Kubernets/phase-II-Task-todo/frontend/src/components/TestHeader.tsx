...
const TestHeader: React.FC<TestHeaderProps> = ({ onMenuClick }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-all duration-200">
