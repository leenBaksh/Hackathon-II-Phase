...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-slate-950 border-slate-800 border-t">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-7xl">
        <div className="gap-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <motion.p 
              className="mb-6 max-w-sm text-slate-400 leading-relaxed"
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="flex justify-center items-center bg-slate-900 hover:bg-slate-800 border border-slate-700 rounded-lg w-10 h-10 text-slate-400 hover:text-slate-200 transition-all duration-200"
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="mb-4 font-semibold text-slate-200 text-sm uppercase tracking-wider">
                {category}
              </h4>
        ...
        {/* Bottom */}
        <motion.div 
          className="flex md:flex-row flex-col justify-between items-center gap-4 mt-12 pt-8 border-slate-800 border-t"
